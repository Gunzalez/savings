	...
	_create: function() {
		...
		var self = this,
			...
			button = this.button
				...
				.addClass( "ui-btn" +
					( options.icon ? ( " ui-nodisc-icon ui-alt-icon ui-icon-" + options.icon + " ui-btn-icon-" + iconpos +
	...
	build: function() {
		...
		if ( this.isMultiple ) {
			headerClose = $( "<a>", {
				...
				"text": o.closeText,
				"href": "#",
				"class": "ui-naked-btn ui-nodisc-icon ui-alt-icon ui-btn ui-corner-all ui-btn-left ui-btn-icon-notext ui-icon-delete"
			}).appendTo( header );
		}
